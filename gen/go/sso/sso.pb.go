...
func (x *MakeAdminResponse) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *RevokeAdminRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *RevokeAdminResponse) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
type LogoutRequest struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Auth token of the user to logout. JWT TOKEN
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_sso_sso_proto_goTypes = []interface{}{
	(*MakeAdminRequest)(nil),    // 0: auth.MakeAdminRequest
	(*MakeAdminResponse)(nil),   // 1: auth.MakeAdminResponse
	(*RevokeAdminRequest)(nil),  // 2: auth.RevokeAdminRequest
	(*RevokeAdminResponse)(nil), // 3: auth.RevokeAdminResponse
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	0,  // 4: auth.Auth.MakeAdmin:input_type -> auth.MakeAdminRequest
	2,  // 5: auth.Auth.RevokeAdmin:input_type -> auth.RevokeAdminRequest
	...
	1,  // 10: auth.Auth.MakeAdmin:output_type -> auth.MakeAdminResponse
	3,  // 11: auth.Auth.RevokeAdmin:output_type -> auth.RevokeAdminResponse
...
func file_sso_sso_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sso_sso_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RevokeAdminRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_sso_sso_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RevokeAdminResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
